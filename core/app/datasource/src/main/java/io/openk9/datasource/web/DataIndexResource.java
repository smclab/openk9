...
public class DataIndexResource {
	...
	@Tag(description = "Permits to generate document types starting from a specific datasource and data index")
	@APIResponses(value = {
	...
	@Tag(description = "Get mappings generate from a list of document types.")
	@APIResponses(value = {
	...
	@Tag(description = "Get settings generate from a list of document types.")
	@APIResponses(value = {
			@APIResponse(responseCode = "200", description = "success"),
			@APIResponse(responseCode = "404", description = "not found"),
			@APIResponse(responseCode = "400", description = "invalid"),
