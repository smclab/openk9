...
package com.openk9.plugins.liferay.enrichprocessor;
...
import com.openk9.search.client.api.Index;
import com.openk9.search.client.api.Search;
import com.openk9.search.enrich.api.BaseNerEnrichProcessor;
...
public class LiferayNerEnrichProcessor extends BaseNerEnrichProcessor {

	@interface Config {
		String url() default "http://spacy-ner-en/";
	...
	@Override
	public String name() {
		return LiferayNerEnrichProcessor.class.getName();
	}
