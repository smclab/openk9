...
public class DemanioPluginDriver extends BasePluginDriver {
	...
	@interface Config {
		...
		String[] jsonKeys() default {
			"startUrls", "allowedDomains", "allowedPaths", "datasourceId", "timestamp", "allowedPaths", "excludedPaths",
				"bodyTag", "pageCount", "maxLength"
		};
	}
