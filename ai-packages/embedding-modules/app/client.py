...
"""Manual smoke client for the EmbedContent server-streaming RPC."""
    ...
    with grpc.insecure_channel("localhost:5000") as channel:
        ...
        for chunk in stub.EmbedContent(request):
            ...
            print(
                ...
                f"dim={chunk.dimension} text={chunk.text[:60]!r}"
            )


if __name__ == "__main__":
    chunk_json_config = Struct()
    chunk_json_config.update({"chunk_size": 100, "chunk_overlap": 20})

    embedding_model = embedding_pb2.EmbeddingModel(
    ...
    # To index binaries, add refs: the module GETs each pre-signed URL and
    # embeds the content, marking every chunk with the ref's fileId.
    #   request.refs.append(
