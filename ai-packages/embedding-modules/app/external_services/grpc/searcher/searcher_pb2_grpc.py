...
class SearcherStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLLMConfigurations = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetEmbeddingModelConfigurations = channel.unary_unary(
                '/grpc.Searcher/GetEmbeddingModelConfigurations',
                request_serializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetEmbeddingModelConfigurationsRequest.SerializeToString,
                response_deserializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetEmbeddingModelConfigurationsResponse.FromString,
                _registered_method=True)
        self.GetRAGConfigurations = channel.unary_unary(
                '/grpc.Searcher/GetRAGConfigurations',
                request_serializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetRAGConfigurationsRequest.SerializeToString,
                response_deserializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetRAGConfigurationsResponse.FromString,
                _registered_method=True)
...
class SearcherServicer(object):
    ...
    def GetEmbeddingModelConfigurations(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def GetRAGConfigurations(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SearcherServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetEmbeddingModelConfigurations': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmbeddingModelConfigurations,
                    request_deserializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetEmbeddingModelConfigurationsRequest.FromString,
                    response_serializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetEmbeddingModelConfigurationsResponse.SerializeToString,
            ),
            'GetRAGConfigurations': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRAGConfigurations,
                    request_deserializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetRAGConfigurationsRequest.FromString,
                    response_serializer=app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetRAGConfigurationsResponse.SerializeToString,
            ),
    }
...
class Searcher(object):
    ...
    @staticmethod
    def GetEmbeddingModelConfigurations(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.Searcher/GetEmbeddingModelConfigurations',
            app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetEmbeddingModelConfigurationsRequest.SerializeToString,
            app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetEmbeddingModelConfigurationsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def GetRAGConfigurations(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.Searcher/GetRAGConfigurations',
            app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetRAGConfigurationsRequest.SerializeToString,
            app_dot_external__services_dot_grpc_dot_searcher_dot_searcher__pb2.GetRAGConfigurationsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
