...
docker buildx build --build-arg PYTHON_BASE_DOCKER_IMAGE="$PYTHON_BASE_DOCKER_IMAGE" . -t openk9-embedding-module-sentence-transformer:"$OPENK9_VERSION" -f Dockerfile.sentence_transformer
