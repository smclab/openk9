...
package io.openk9.search.client.writer.indextemplate;
...
public class EntityIndexTemplateInitializer extends
	...
	public String indexTemplatePath() {
		return "mappings/base-entity-index-template.json";
	}

	@Override
	public String indexTemplateName() {
		return "base_entity_template";
	}
