...
public final class FastBootHibernateReactivePersistenceProvider implements PersistenceProvider {
    ...
    public EntityManagerFactory createEntityManagerFactory(String emName, Map properties) {
        ...
        try {
			...
			final List<RuntimePersistenceUnitDescriptor> units =
    ...
    private EntityManagerFactoryBuilder getEntityManagerFactoryBuilderOrNull(
		...
		Map<String, HibernateOrmRuntimeConfigPersistenceUnit> puConfigMap =
        ...
        for (RuntimePersistenceUnitDescriptor persistenceUnit : units) {
            ...
            var puConfig = puConfigMap.getOrDefault(
            ...
            for (Map.Entry<String, String> entry : puConfig.unsupportedProperties.entrySet()) {
                ...
                if (runtimeSettingsBuilder.get(key) != null) {
                    log.warnf(
						"Persistence-unit [%s] sets property '%s' to a custom value through '%s',"
