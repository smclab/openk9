                ...
                <TableCell>
                  ...
                  >
                    {(() => {
                      ...
                      const shouldCollapse = maxVisibleActions !== undefined && allActions.length > maxVisibleActions;
                      const visibleActions = shouldCollapse ? allActions.slice(0, maxVisibleActions) : allActions;
