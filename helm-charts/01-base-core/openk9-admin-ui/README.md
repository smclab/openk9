...
```bash
helm upgrade -i admin-ui openk9/openk9-admin-ui
```
...
| ------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------- |
| `image.registry`    | Openk9 Admin Ui image registry                                                                                  | `REGISTRY_NAME`            |
| `image.repository`  | Openk9 Admin Ui image repository                                                                                | `REPOSITORY_NAME/openk9` |
| `image.digest`      | Openk9 Admin Ui image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag | `""`                       |
| `image.pullPolicy`  | Openk9 Admin Ui image pull policy                                                                               | `IfNotPresent`             |
...
Openk9 Admin Ui doesn't need particular Service Account or rbac. 

But if you want for some reasons associate a pre-created Service Account to Openk9 Admin Ui you can do using following parameters:
