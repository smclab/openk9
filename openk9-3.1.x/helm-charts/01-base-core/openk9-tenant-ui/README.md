# Helm package for Openk9 tenant ui

## Introduction

This chart bootstraps Openk9 tenant ui deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
```bash
helm upgrade -i tenant-ui openk9/openk9-tenant-ui
```
...
| ------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------- |
| `image.registry`    | Openk9 tenant ui image registry                                                                                  | `REGISTRY_NAME`            |
| `image.repository`  | Openk9 tenant ui image repository                                                                                | `REPOSITORY_NAME/openk9` |
| `image.digest`      | Openk9 tenant ui image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag | `""`                       |
| `image.pullPolicy`  | Openk9 tenant ui image pull policy                                                                               | `IfNotPresent`             |
...
Openk9 tenant ui doesn't need particular Service Account or rbac. 

But if you want for some reasons associate a pre-created Service Account to Openk9 tenant ui you can do using following parameters:
...
Openk9 tenant ui chart allow setting resource requests and limits for all containers inside the chart deployment. These are inside the `resources` value (check parameter table). Setting requests is essential for production workloads and these should be adapted to your specific use case.
...
| Name                | Description                                                                                              | Value                      |
| ------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------- |
| `podSecurityContext.enabled`                        | Enable tenant ui pods' Security Context                                                                                                                                                                            | `true`           |
| `podSecurityContext.fsGroupChangePolicy`            | Set filesystem group change policy                                                                                                                                                                                | `Always`         |
| `podSecurityContext.sysctls`                        | Set kernel settings using the sysctl interface                                                                                                                                                                    | `[]`             |
| `podSecurityContext.supplementalGroups`             | Set filesystem extra groups                                                                                                                                                                                       | `[]`             |
| `podSecurityContext.fsGroup`                        | Set tenant ui pod's Security Context fsGroup                                                                                                                                                                       | `1001`           |
| `podSecurityContext.enabled`                  | Enabled tenant ui containers' Security Context                                                                                                                                                                     | `true`           |
| `podSecurityContext.runAsUser`                | Set tenant ui containers' Security Context runAsUser                                                                                                                                                               | `1001`           |
| `podSecurityContext.runAsGroup`               | Set tenant ui containers' Security Context runAsGroup                                                                                                                                                              | `1001`           |
| `podSecurityContext.runAsNonRoot`             | Set tenant ui container's Security Context runAsNonRoot                                                                                                                                                            | `true`           |
