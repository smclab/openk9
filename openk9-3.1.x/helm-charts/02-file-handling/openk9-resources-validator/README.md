# Helm package for Openk9 Resources Validator

## Introduction

This chart bootstraps Openk9 Resources Validator deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
```bash
helm upgrade -i resources-validator openk9/openk9-resources-validator
```
...
| ------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------- |
| `image.registry`    | Openk9 Resources Validator image registry                                                                                  | `REGISTRY_NAME`            |
| `image.repository`  | Openk9 Resources Validator image repository                                                                                | `REPOSITORY_NAME/openk9` |
| `image.digest`      | Openk9 Resources Validator image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag | `""`                       |
| `image.pullPolicy`  | Openk9 Resources Validator image pull policy                                                                               | `IfNotPresent`             |
...
| Name                                         | Description                                                                                                                                                             | Value                                             |
| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| `nameOverride`                               | String to partially override resources-validator.fullname template (will maintain the release name)                                                                                | `""`                                              |
| `fullnameOverride`                           | String to fully override resources-validator.fullname template                                                                                                                     | `""`                                              |
| `commonAnnotations`                          | Annotations to add to all deployed objects                                                                                                                              | `{}`                                              |
| `hostAliases`                                | Deployment pod host aliases                                                                                                                                             | `[]`                                              |

### Quarkus configurations

Openk9 Resources Validator service is based on Quarkus Framework. Use following parameters to set main quarkus configurations.
...
Openk9 Resources Validator is a JVM service. To control JVM based tool options use following parameters:
...
Openk9 Resources Validator needs Opensearch to work. 
...
Openk9 Resources Validator supports collecting metrics about traffic using OpenTelemetry.
...
Openk9 Resources Validator doesn't need particular Service Account or rbac. 

But if you want for some reasons associate a pre-created Service Account to Openk9 Resources Validator you can do using following parameters:
...
Openk9 Resources Validator doesn't need to openk9 Apis externally.
...
Openk9 Resources Validator supports Readiness, Liveness and Startup Probes.
...
Openk9 Resources Validator chart allow setting resource requests and limits for all containers inside the chart deployment. These are inside the `resources` value (check parameter table). Setting requests is essential for production workloads and these should be adapted to your specific use case.
